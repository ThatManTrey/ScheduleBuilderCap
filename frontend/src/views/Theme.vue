            ...
            <div class="row course-container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-6 mb-3 bg-theme-blacker">
                        ...
                        <i class="fas fa-question-circle fa-lg text-theme-primary"></i> &nbsp; <i class="fas fa-home fa-lg text-theme-whitest"></i> &nbsp;
                ...
                <div class="row mt-3">
                    <div class="col bg-theme-blacker">
                        <br />
                        <h5 class="text-theme-whitest">Spinner Test</h5>
                        <br />
                        <p class="text-theme-white">fades out and disappears after 5s</p>
    
                        <Spinner :showSpinner=!hasLoaded></Spinner>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-12 col-md-10 col-lg-8 mb-3">
                        <div class="container-fluid mb-3 text-white">
                            ...
                            <br />
                            <div></div>
                            <div class="row text-theme-whitest" v-for="(color, index) in primaryColors" :key="index">
                                <div class="col-2">{{ color.name }} &nbsp;</div>
                                <div class="col-6 color-test" :class="'bg-theme-' + color.name"></div>
                        ...
                        <div class="container-fluid">
                            ...
                            <br />
                            <div class="row text-theme-whitest" v-for="(color, index) in accentColors" :key="index">
                                <div class="col-2">{{ color.name }} &nbsp;</div>
                                <div class="col-6 color-test" :class="'bg-theme-' + color.name"></div>
                                <div class="col-4">&nbsp; {{ color.uses }}</div>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="theme-modal-content">
                            ...
                            <div class="theme-modal-footer">
                                <button type="button" class="btn btn-theme-dark" data-bs-dismiss="modal">
                              Cancel
                            </button>
                                <button type="button" class="btn btn-theme-primary" data-bs-dismiss="modal">
                              Continue
                            </button>
                            </div>
                        </div>
